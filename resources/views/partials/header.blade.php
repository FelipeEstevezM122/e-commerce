<header class="w-full font-['Poppins'] relative">
    ...
    <nav class="bg-white shadow-md border-b border-gray-100 px-4 md:px-12 py-3 flex justify-between items-center">
        
        <a href="{{ url('/') }}" class="flex items-center gap-3 text-xl font-black tracking-tight text-[#111111] group">
            <img src="{{ asset('images/logoCasatek.jpg') }}" alt="Logo Casatek" class="h-10 w-auto object-contain transition-transform group-hover:scale-105 duration-200">
            <span class="font-['Poppins'] tracking-tight">
                CASA<span class="text-[#22C55E]">TEK</span>
            </span>
        </a>

        <div class="flex items-center gap-4 md:gap-8">
            <ul class="hidden md:flex items-center gap-8 text-sm font-bold tracking-wide text-[#111111]">
            ...
            <button id="btn-open-menu-mobile" class="block md:hidden text-xl text-gray-800 hover:text-[#22C55E] focus:outline-none p-2">
    ...
    <div id="sidebar-panel" class="fixed top-0 right-0 h-full w-full sm:w-[400px] bg-[#111111] text-white z-50 p-8 flex flex-col justify-between transform translate-x-full transition-transform duration-300 ease-in-out shadow-2xl overflow-y-auto select-none">
        ...
        <div>
            ...
            <div class="mt-4 flex justify-center">
                <h2 class="text-3xl font-black tracking-widest text-white font-['Poppins']">
                    CASA<span class="text-white/90 font-light">TEK</span>
                </h2>
            </div>
            ...
            <div class="mt-8 space-y-4">
                <div class="flex items-center gap-3">
                    <div class="text-[#22C55E] text-2xl animate-pulse">
