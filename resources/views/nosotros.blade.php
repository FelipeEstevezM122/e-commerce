...
<div class="space-y-20 font-['Poppins'] pb-12">
    ...
    <section class="text-center max-w-2xl mx-auto space-y-3 pt-4">
        <span class="text-xs font-bold text-[#1b803a] tracking-widest uppercase">Conoce nuestro equipo</span>
        <h1 class="text-3xl md:text-5xl font-extrabold text-gray-900 tracking-tight">
            Sobre <span class="text-[#1b803a]">Nosotros</span>
        </h1>
    ...
    <section class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div class="space-y-6 order-2 lg:order-1">
            <div class="space-y-2">
                <span class="text-xs font-bold text-gray-400 tracking-widest uppercase flex items-center gap-2">
                    <span class="w-4 h-[1px] bg-gray-400"></span> Trayectoria
                </span>
        ...
        <div class="relative flex justify-center order-1 lg:order-2">
            <div class="absolute inset-0 bg-[#1b803a]/5 rounded-3xl transform rotate-2 scale-102 -z-10"></div>
            <img src="{{ asset('images/nuestra-historia.jpg') }}" alt="Historia de Casatek" class="w-full max-w-md h-[300px] object-cover rounded-3xl shadow-sm border border-gray-100">
        </div>
    </section>

    <section class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div class="relative flex justify-center">
            <div class="absolute inset-0 bg-[#22C55E]/5 rounded-3xl transform -rotate-2 scale-102 -z-10"></div>
            <img src="{{ asset('images/nuestra-mision.jpg') }}" alt="Misión Casatek" class="w-full max-w-md h-[300px] object-cover rounded-3xl shadow-sm border border-gray-100">
        </div>

        <div class="space-y-8">
            <div class="space-y-3">
                <div class="space-y-1">
                    <span class="text-xs font-bold text-[#1b803a] tracking-widest uppercase">El Propósito</span>
                    <h2 class="text-2xl font-extrabold text-gray-900 tracking-tight">Nuestra Misión</h2>
                </div>
            ...
            <div class="space-y-3">
                <div class="space-y-1">
                    ...
                    <h2 class="text-2xl font-extrabold text-gray-900 tracking-tight">Nuestra Visión</h2>
                </div>
                <p class="text-sm text-gray-600 leading-relaxed font-medium">
    ...
    <section class="space-y-8">
        <div class="text-center space-y-1">
            <span class="text-xs font-bold text-gray-400 tracking-widest uppercase">Pilares de Trabajo</span>
            <h2 class="text-2xl font-extrabold text-gray-900 tracking-tight">Los Valores que nos Mueven</h2>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all space-y-4">
                <div class="w-12 h-12 bg-green-50 text-[#1b803a] rounded-xl flex items-center justify-center">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                </div>
                <h3 class="text-sm font-bold text-gray-900">Compromiso y Garantía</h3>
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all space-y-4">
                ...
                <h3 class="text-sm font-bold text-gray-900">Innovación Tecnológica</h3>
                <p class="text-xs text-gray-500 leading-relaxed font-medium">
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all space-y-4">
                ...
                <h3 class="text-sm font-bold text-gray-900">Personal Profesional</h3>
                <p class="text-xs text-gray-500 leading-relaxed font-medium">
