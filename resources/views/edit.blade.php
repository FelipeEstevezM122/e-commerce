    ...
    <form action="{{ route('admin.products.update', $product->id) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <select name="brand_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm">
            ...
            <div>
                ...
                <select name="category_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm">
        ...
        <div>
            ...
            <p class="text-xs text-gray-400 mt-1">
                Subí una imagen nueva en el campo correspondiente para reemplazarla. Los campos vacíos conservan la imagen actual.
            </p>
        </div>
        @endif
